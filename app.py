...
API_KEY = 'AIzaSyCPW4xKl5GNg69cRnqu92Cj1ofJBlmj6qQ'
print(API_KEY)
...
def channels():
    '''This page returns the channel comparison analysis when a user selects at least one channel with a radio button and hits "Compare channels now"'''
    result_dictionary = request.args
    print("abc")
    channel_ids = []
    ...
    image_names.append(viz.piechart_channel_like_count(video_df, channel_ids))
    image_names.append(viz.barplot_links(video_df, channel_ids))
    #image_names.append(viz.histogram_video_duration_count(video_df, channel_ids))
